...
export const options = {
  ...
  thresholds: {
    ...
    http_req_duration: ['p(99)<3000', 'p(99.9)<4500'],
    req_restaurants_duration: ['p(99)<3000', 'p(99.9)<4500'],
    req_menu_duration: ['p(99)<3000', 'p(99.9)<4500'],
    req_create_order_duration: ['p(99)<3500', 'p(99.9)<5000'],
    req_pay_duration: ['p(99)<3500', 'p(99.9)<5000'],
    req_tracking_duration: ['p(99)<3000', 'p(99.9)<4500'],
  },
};
...
export default function () {
  ...
  const created = check(create, { 'order 201': (r) => r.status === 201 });
  if (!created) {
    sleep(0.5);
    return;
  }
  ...
  check(pay, { 'pay 202': (r) => r.status === 202 });
  ...
  check(tracking, { 'tracking 200': (r) => r.status === 200 });
