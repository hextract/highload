...
export const options = {
  ...
  thresholds: {
    ...
    http_req_duration: ['p(99)<3500', 'p(99.9)<5000'],
    req_restaurants_duration: ['p(99)<3000', 'p(99.9)<4500'],
    req_menu_duration: ['p(99)<3000', 'p(99.9)<4500'],
    req_create_order_duration: ['p(99)<4000', 'p(99.9)<5500'],
    req_pay_duration: ['p(99)<4000', 'p(99.9)<5500'],
  },
};
...
export default function () {
  // Read-heavy + occasional write flow.
